...
// import VenkataSai from'../Assets/Images/Venkata_Sai.jpeg';
...
export class DashBoardData extends React.Component {
    constructor(props){
        super(props)
        this.state={
                ...
                <div className='dashboard-div'>
                    ...
                    <div className='dashboard-content'>
                        <div className='dashboard-header'>
                            ...
                            {/* <img src={VenkataSai} alt="venkatasai" className='dashboard-header-img'/> */}
                        </div>
    ...
    render(){
        return(
            <div className='add-new-profile'>
                <p className='new-profile-name'>Add New Profile... <span className='profile-x-icon' onClick={this.closeModal}></span></p>
